...
{{--                    Neue Links eingefügt, Dashboard entfernt--}}
                    <x-nav-link :href="route('trainings.index')" :active="request()->routeIs('trainings.index')">
                        {{ __('Trainings') }}
                    </x-nav-link>
                    <x-nav-link :href="route('training-names.index')" :active="request()->routeIs('training-names.index')">
                        {{ __('Training Namen') }}
                    </x-nav-link>
                </div>
            </div>
...
{{--        Neue Links eingefügt, Dashboard entfernt--}}
            ...
            <x-responsive-nav-link :href="route('training-names.index')" :active="request()->routeIs('training-names.index')">
                {{ __('Training Namen') }}
            </x-responsive-nav-link>
        </div>
